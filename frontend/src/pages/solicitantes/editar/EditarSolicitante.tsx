...
const EditarSolicitante = () => {
  ...
  const formik = useFormik({
    initialValues: {
      cnpj: solicitante[0].cnpj,
      nome: solicitante[0].nome,
      cep: solicitante[0].cep,
      endereco: solicitante[0].endereco,
      numero: solicitante[0].numero,
      cidade: solicitante[0].cidade,
      estado: solicitante[0].estado,
      responsavel: solicitante[0].responsavel,
      email: solicitante[0].email,
    ...
    onSubmit: async (values: CadastrarSolicitanteRequest) => {
      await axios.patch(
        `https://uno-production.up.railway.app/solicitantes/${cnpj}`,
        values
      );
      setOpen(true);
      formik.setValues({
        ...
        <div className="space-y-12 ">
          <div className="border-b border-gray-900/10 pb-7">
            ...
            <p className="font-inter mt-1 text-sm leading-6 text-gray-600">
              Atualize cuidadosamente as informações do solicitante
            </p>
          </div>
        </div>
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div>
                          <p className="text-sm text-gray-500 font-inter">
                            O solicitante {formik.values.nome} foi atualizado
                            com sucesso!
                          </p>
                        </div>
                      </div>
